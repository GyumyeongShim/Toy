...
public class StageController : MonoBehaviour //추후 씬매니저가 이런것을 몇개 가지고 있을것
{
    ...
    [SerializeField]
    private GameObject m_panelResult;

    [SerializeField]
    private TextMeshProUGUI m_textResultScore;
    ...
    void Start()
    {
        if(Managers.Scene.GetActiveSceneName() == "RollABall1")
        {
